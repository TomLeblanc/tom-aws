...
class TestEmployeeAPI(unittest.TestCase):
    ...
    def test_delete_employee(self):
        ...
        data = json.loads(response.data)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(data['message'], f"L'employé avec l'ID {employee_id} a été supprimé")
    ...
    def test_update_employee(self):
        ...
        self.assertEqual(data['firstName'], new_employee_data['firstName'])
        self.assertEqual(data['lastName'], new_employee_data['lastName'])
        self.assertEqual(data['emailId'], new_employee_data['emailId'])
